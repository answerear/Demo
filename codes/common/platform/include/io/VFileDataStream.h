 ...
 * All rights reserved.
 *
 * @file    VFileDataStream.h
 * @brief   文件流类定义.
 * @author  aaronwang
 * @date    2014/2/9 23:38:33
 * @version v1.00
 **************************************************************************************************/
...
{	
	 ...
	 * @note 该类提供文件流读写操作.
	 */
	class VPLATFORM_API VFileDataStream : public VDataStream
	{
		V_DISABLE_COPY(VFileDataStream);
	...
	public:
		...
		/**
		 * @brief Constructor for VFileDataStream.
		 */
		VFileDataStream();

		/**
		 * @brief Destructor for VFileDataStream.
		 */
